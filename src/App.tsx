...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#121212] text-[#e4d5b7] font-sans" onClick={playAudio}>
      ...
      {appState === 'HISTORY' && (
        <PreviousAdventure onClose={() => handleStateChange('MENU')} />
      )}
      ...
      {appState === 'GAME' && (
        <div className="flex flex-col h-screen relative">
          <div className="flex items-center bg-[#1e1e1e] p-4 border-b border-[#333333] shadow-md z-10 relative">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-[#d4af37] absolute left-1/2 -translate-x-1/2 whitespace-nowrap" style={{ fontFamily: 'Cinzel, serif' }}>
              Loup Solitaire
            </h1>
          </div>
          ...
          {showDropdownMenu && (
            <>
              <div 
                ...
                style={{ backgroundColor: 'rgba(0, 0, 0, 0.1)', backdropFilter: 'blur(4px)', WebkitBackdropFilter: 'blur(4px)' }}
