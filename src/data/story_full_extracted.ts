...
export const storyDataExtracted: Record<string, Section> = {
  ...
  "6": {
    "id": "6",
    "text": "Vous entendez au loin des chevaux dont le galop se rapproche et vous vous accroupissez derrière un arbre pour voir passer les cavaliers sans être vu. Bientôt, vous reconnaissez l'uniforme blanc de l'armée du Sommerlund : ce sont des soldats de la Garde du Roi. Si vous souhaitez les appeler, rendez-vous au 183. Si vous préférez les laisser passer et poursuivre votre chemin à travers la forêt, rendez-vous au 200.",
    "choices": [
      {
  ...
  "8": {
    "id": "8",
    "text": "Votre Sixième Sens vous avertit qu'une terrible bataille fait rage dans le sud. Mais votre simple bon sens vous rappelle également que le chemin le plus court pour rejoindre la capitale passe précisément par le sud. Rendez-vous au 70 pour établir votre itinéraire.",
    "choices": [
      {
  ...
  "10": {
    "id": "10",
    "text": "Vous êtes en sueur et vos jambes vous font mal. Un peu plus loin, vous apercevez quelques maisonnettes rassemblées. Si vous souhaitez entrer dans l'une de ces maisonnettes pour y prendre quelque repos, rendez-vous au 115. Si vous préférez poursuivre votre chemin, rendez-vous au 83.",
    "choices": [
      {
  ...
  "13": {
    "id": "13",
    "text": "Le chemin aboutit bientôt à une vaste clairière. En son centre se dresse un arbre plus haut et plus large que les autres. Nichée dans son feuillage, à quelque huit mètres au-dessus du sol, se trouve une grande maison. Aucune échelle ne permet d'y accéder, mais l'écorce noueuse de l'arbre offre de nombreux points d'appui et il ne doit pas être trop difficile de grimper là- haut. Si vous souhaitez escalader cet arbre pour inspecter la maison, rendez-vous au 307. Si vous préférez poursuivre votre chemin, rendez-vous au 213.",
    "choices": [
      {
  ...
  "14": {
    "id": "14",
    "text": "Vous parvenez au sommet d'une petite colline boisée. De gros rocs y sont disposés les uns à côté des autres, formant un cercle grossier. Soudain, vous entendez un grognement sonore qui s'élève de derrière un rocher situé à votre gauche. Si vous voulez dégainer votre arme et vous préparer à combattre, rendez-vous au 43. Si vous préférez prendre la fuite en courant le plus vite possible au bas de la colline, rendez-vous au 106.",
    "choices": [
      {
  ...
  "15": {
    "id": "15",
    "text": "Vous longez un long tunnel sombre formé par des branches d'arbres qui s'entrecroisent au-dessus de votre tête et vous arrivez enfin dans une vaste clairière. En son centre se dresse un socle de pierre sur lequel est posée une épée, rangée dans un fourreau de cuir noir. Un mot manuscrit est attaché à la garde de l'épée, mais il est écrit dans une langue qui vous est étrangère. Vous pouvez prendre cette épée si vous le désirez en n'oubliant pas de l'inscrire sur votre Feuille d'Aventure. Trois chemins permettent de quitter la clairière : si vous voulez aller à l'est, rendez-vous au 207. A l'ouest, rendez-vous au 201. Au sud, rendez-vous au 35.",
    "choices": [
      {
  ...
  "16": {
    "id": "16",
    "text": "Vous parvenez à détacher l'un des chevaux de la roulotte. L'odeur des Loups Maudits et les cris des Gloks qui les chevauchent semblent l'effrayer, mais vous arrivez malgré tout à le lancer au galop en direction des monstrueuses créatures qui s'approchent de vous. Les Gloks et leurs montures sataniques ne sont plus qu'à une cinquantaine de mètres, la lance pointée en avant. Face à face à présent, vous foncez les uns vers les autres. Rendez-vous au 192.",
    "choices": [
      {
  ...
  "20": {
    "id": "20",
    "text": "Il semble que le ou les occupants de la péniche soient partis en toute hâte il y a peu de temps. Les restes d'un repas à moitié mangé traînent sur la table ainsi qu'une tasse de Jala encore chaud. En fouillant un coffre et un petit placard, vous trouvez un Sac à Dos, de la Nourriture (l'équivalent de 2 Repas) et un Poignard. Si vous souhaitez emporter l'un ou l'autre de ces objets (ou tous les trois), n'oubliez pas de les inscrire sur votre Feuille d'Aventure. Rendez-vous ensuite au 272.",
    "choices": [
      {
  ...
  "23": {
    "id": "23",
    "text": "Le couloir aboutit bientôt à une vaste chambre mortuaire dont les murs sont gravés de motifs anciens. Dans le coin opposé, un escalier de pierre mène à une porte immense. De chaque côté des marches, deux chandelles noires diffusent une faible clarté. Vous remarquez alors qu'aucune cire ne coule le long des chandelles, et tandis que vous vous approchez, vous constatez que leurs flammes ne diffusent aucune chaleur. Soucieux de quitter au plus vite cet endroit sinistre, vous examinez la serrure de la porte. Une broche sculptée semble fermer le panneau, mais un trou de serrure apparaît également. Si vous souhaitez retirer la broche, rendez-vous au 337. Si vous possédez la Discipline Kaï de la Maîtrise Psychique de la Matière, rendez-vous au 151. Enfin, si vous avez une Clé d'Or, rendez-vous au 326.",
    "choices": [
      {
  ...
  "24": {
    "id": "24",
    "text": "Le marchand crie au conducteur de la roulotte de sauter. « On nous attaque ! » s'exclame-t-il. Puis il se jette au-dehors par une fenêtre circulaire. Si vous souhaitez sauter à votre tour de la roulotte, rendez-vous au 234. Si vous préférez essayer d'attraper les rênes des chevaux pour prendre le contrôle de l'attelage, rendez-vous au 184.",
    "choices": [
      {
  ...
  "26": {
    "id": "26",
    "text": "Vous avancez prudemment le long du couloir qui tourne bientôt à angle droit en direction de l'est. Au loin, vous apercevez une étrange lueur verdâtre. Si vous souhaitez continuer dans cette direction, rendez-vous au 249. Si vous préférez rebrousser chemin et prendre le couloir orienté au sud, rendez-vous au 100.",
    "choices": [
      {
  ...
  "27": {
    "id": "27",
    "text": "Vous suivez ce chemin pendant plus d'une heure en surveillant le ciel de peur que le Kraan n'attaque à nouveau. A quelque distance devant vous, un grand arbre s'est abattu en travers du sentier, et lorsque vous vous en approchez, vous entendez des voix qui s'élèvent de l'autre côté du tronc massif. Si vous souhaitez passer à l'attaque, rendez-vous au 250. Si vous préférez écouter ce que disent ces voix, rendez-vous au 52.",
    "choices": [
      {
  ...
  "28": {
    "id": "28",
    "text": "Une centaine de mètres plus loin, le sentier en croise un autre orienté nord-sud. Si vous souhaitez prendre la direction du nord, rendez-vous au 130. Si vous préférez aller au sud, rendez-vous au 147.",
    "choices": [
      {
  ...
  "32": {
    "id": "32",
    "text": "Vous avez parcouru environ cinq kilomètres à cheval lorsque vous apercevez à quelque distance la silhouette caractéristique de cinq grands Loups Maudits. Des Gloks les chevauchent et ils semblent se diriger vers une prairie située au bout du chemin. Soudain, l'un des Gloks s'écarte de ses compagnons et revient sur ses pas, lançant sa monture en direction de l'endroit où vous vous trouvez. Si vous souhaitez vous cacher dans les sous-bois et le laisser passer, rendez-vous au 176. Si vous préférez le combattre, rendez-vous au 340.",
    "choices": [
      {
  ...
  "37": {
    "id": "37",
    "text": "Vous vous sentez fatigué et affamé, et il vous faut faire une halte pour prendre un Repas. Après avoir mangé, vous rebroussez chemin jusqu'à la citadelle et vous marchez le long de ses hautes murailles de pierre. Vous découvrez une autre entrée dans le mur est, gardée, elle aussi, par deux soldats en armes. Si vous voulez vous approcher d'eux et leur raconter votre histoire, rendez-vous au 289. Si vous maîtrisez la Discipline Kaï du Camouflage, rendez-vous au 282.",
    "choices": [
      {
  ...
  "40": {
    "id": "40",
    "text": "Vous contournez la clairière avec précaution en progressant à l'abri des arbres et en surveillant les huttes pour y déceler toute présence éventuelle de l'ennemi. Bientôt, vous rejoignez le sentier et vous vous éloignez en hâte du Bois des Brumes. Rendez-vous au 105.",
    "choices": [
      {
  ...
  "44": {
    "id": "44",
    "text": "Le sentier aboutit brusquement à une pente en à-pic. Le sol, très instable à cet endroit, se dérobe sous vos pas : vous perdez l'équilibre et vous tombez tête la première au bas de la pente. Utilisez la Table de Hasard pour obtenir un chiffre : si vous tirez un chiffre entre 0 et 4, rendez-vous au 277. Entre 5 et 9, rendez- vous au 338.",
    "choices": [
      {
  ...
  "46": {
    "id": "46",
    "text": "Vous avez parcouru trois kilomètres environ, et le feuillage des arbres commence à s'éclaircir. Vous apercevez alors, au bord d'un lac, une petite cabane de bois. Un homme vêtu d'une cape s'approche bientôt de vous et vous offre de vous faire traverser le lac sur son bateau, vous et votre cheval, pour la somme de 2 Couronnes. Si vous acceptez son offre, rendez-vous au 246. Si vous préférez refuser et contourner le lac à cheval, rendez-vous au 90. Enfin, si vous maîtrisez la Discipline Kaï du Sixième Sens, rendez-vous au 296.",
    "choices": [
      {
  ...
  "47": {
    "id": "47",
    "text": "A bout de souffle et le visage ruisselant de sueur, vous vous frayez un chemin vers le sommet de la colline. Mais, soudain, une immense ombre noire se dessine devant vous : c'est un Kraan qui tournoie dans le ciel tandis que les Gloks, dans votre dos, gagnent peu à peu du terrain. Souhaitez-vous attendre les Gloks pour les affronter en prenant avantage de votre position élevée ? Rendez-vous dans ce cas au 136. Préférez-vous serrer les dents et poursuivre l'escalade jusqu'au sommet ? Vous vous rendrez alors au 322.",
    "choices": [
      {
  ...
  "48": {
    "id": "48",
    "text": "Votre Sixième Sens vous avertit que ces soldats ne sont pas ce qu'ils semblent être. Vous percevez une aura maléfique autour d'eux : ce sont des serviteurs des Maîtres des Ténèbres. Il vous faut prendre aussitôt la fuite avant qu'ils vous aperçoivent. Rendez-vous au 243.",
    "choices": [
      {
  ...
  "49": {
    "id": "49",
    "text": "Tandis que vous lisez l'inscription, une ombre se dessine derrière le paravent. Utilisez la Table de Hasard pour obtenir un chiffre : Si vous tirez un chiffre entre 0 et 4, rendez-vous au 339. Entre 5 et 9, rendez-vous au 60.",
    "choices": [
      {
  ...
  "52": {
    "id": "52",
    "text": "A présent que vous vous êtes approché, vous vous apercevez qu'il ne s'agit pas là de voix humaines. On dirait plutôt des grognements et des cris d'animaux. Si vous maîtrisez la Discipline Kaï de la Communication animale, rendez-vous au 225. Sinon, montez sur le tronc de l'arbre pour aller voir qui se cache derrière. Rendez-vous pour cela au 250.",
    "choices": [
      {
  ...
  "57": {
    "id": "57",
    "text": "La cabane n'a qu'une seule pièce meublée d'une table de bois, de deux bancs et d'un lit fait de bottes de paille attachées ensemble. Un tapis brodé orne le plancher et plusieurs bouteilles contenant des liquides de différentes couleurs sont posées sur la table. Si vous souhaitez examiner ces bouteilles, rendez-vous au 164. Si vous voulez soulever le tapis, rendez-vous au 109. Si vous préférez quitter la cabane et inspecter l'écurie, rendez-vous au 308.",
    "choices": [
      {
  ...
  "59": {
    "id": "59",
    "text": "Scrutant l'obscurité, vous distinguez quelques marches taillées grossièrement dans la terre et vous vous apercevez que cette grotte est en fait l'entrée d'un tunnel. Vous descendez prudemment les marches glissantes et vous découvrez au bas de cet escalier de fortune une petite boîte en argent posée sur une étagère. Si vous souhaitez ouvrir la boîte, rendez-vous au 124. Si vous préférez ressortir et poursuivre votre chemin, rendez-vous au 106. Si vous choisissez enfin de vous enfoncer plus avant dans le tunnel, rendez-vous au 211.",
    "choices": [
      {
  ...
  "67": {
    "id": "67",
    "text": "Votre Sens de l'Orientation vous permet de découvrir des traces fraîches laissées par les pattes d'un animal. Ces empreintes suivent le chemin orienté au sud. Vous reconnaissez là les traces d'un Ours Noir. C'est un animal connu pour sa férocité et vous estimez préférable d'emprunter le sentier qui mène vers l'est. Rendez-vous au 140.",
    "choices": [
      {
  ...
  "68": {
    "id": "68",
    "text": "Bientôt, le chemin que vous suivez en croise un autre orienté est- ouest. Si vous souhaitez aller à l'ouest, rendez-vous au 130. Si vous préférez prendre la direction de l'est, rendez-vous au 15.",
    "choices": [
      {
  ...
  "70": {
    "id": "70",
    "text": "Vous arrivez à un petit pont. Un chemin longe le cours d'eau en direction de l'est, et un autre sentier beaucoup plus étroit s'enfonce dans une forêt touffue menant vers le sud. Si vous souhaitez aller à l'est, rendez-vous au 28. Si vous préférez prendre la direction du sud, rendez-vous au 157. Enfin, si vous maîtrisez la Discipline Kaï du Sixième Sens, rendez-vous au 8.",
    "choices": [
      {
  ...
  "71": {
    "id": "71",
    "text": "Vous êtes étourdi, mais indemne. Vous avez fait une chute de cinq mètres en passant à travers le plafond d'un caveau souterrain. Les murs en sont parfaitement lisses, et il vous est impossible d'y grimper. Un tunnel voûté part du caveau en direction de l'est. A l'entrée de ce tunnel se trouve le sarcophage de quelque ancien seigneur. Si vous souhaitez ouvrir ce sarcophage dans l'espoir d'y découvrir des objets de valeur, rendez-vous au 242. Si vous préférez quitter le tombeau et suivre le tunnel, rendez-vous au 104. Enfin, si vous maîtrisez la Discipline Kaï du Sixième Sens, rendez-vous au 65.",
    "choices": [
      {
  ...
  "73": {
    "id": "73",
    "text": "Vous ramenez votre cape autour de vos épaules et vous vous fondez dans les rochers et les feuillages. Puis vous observez attentivement les nouveaux arrivants et vous vous apercevez alors avec un frisson d'horreur qu'il ne s'agit pas du tout de soldats du Roi. Ce sont, en fait, des Drakkarims qui comptent parmi les plus cruels serviteurs des Maîtres des Ténèbres. Ils se sont déguisés en gardes de l'armée royale pour n'être pas reconnus et pouvoir ainsi traverser la forêt sans encombre. Votre initiation aux Disciplines Kaï vous a sauvé la vie et vous remerciez intérieurement vos maîtres. Quelques instants plus tard, vous avez quitté la rive du cours d'eau et vous vous enfoncez dans la forêt en prenant garde à ne pas faire de bruit. Rendez- vous au 243.",
    "choices": []
  },
  "74": {
    "id": "74",
    "text": "Les Kraans et leurs maîtres atterrissent sur le chemin, à trois mètres à peine de l'endroit où vous vous êtes caché. Les Gloks sautent alors de leurs montures volantes à la peau couverte d'écaillés et s'avancent vers vous, la lance levée : ils vous ont vu. Si vous décidez de les combattre, rendez-vous au 138. Si vous préférez prendre la fuite en courant dans la forêt, rendez-vous au 281.",
    "choices": [
      {
  ...
  "76": {
    "id": "76",
    "text": "La Pierre dégage une intense chaleur et vous brûle la main. Vous perdez 2 points d'ENDURANCE. Vous enveloppez alors la Pierre dans un pan de votre cape et vous la laissez tomber dans une poche de votre tunique. Une Pierre Précieuse de cette taille doit valoir des centaines de Couronnes ! Vous vous réjouissez de votre bonne fortune et vous remontez sur votre cheval que vous lancez au galop sur le chemin orienté au sud. Rendez-vous au 118.",
    "choices": [
      {
  ...
  "78": {
    "id": "78",
    "text": "Au moment où la roulotte passe devant vous, vous faites un bond en avant et vous parvenez à vous y agripper; vous vous retrouvez sur l'échelon inférieur d'un petit escabeau qui permet d'accéder à la porte arrière du véhicule. Vous vous redressez avec précaution en vous efforçant de maintenir votre prise et, soudain, la partie supérieure de la porte qui vous fait face s'ouvre à la volée. Le visage furieux d'un garde du corps apparaît alors dans l'encadrement. Si vous souhaitez lui expliquer que vous êtes un Seigneur Kaï, porteur d'un message urgent destiné au Roi, rendez-vous au 132. Si vous choisissez de lui offrir de l'Or pour payer votre voyage jusqu'à la capitale, rendez-vous au 12. Enfin, si vous décidez d'attaquer le garde avec votre arme, rendez-vous au 220.",
    "choices": [
      {
  ...
  "80": {
    "id": "80",
    "text": "Vous trébuchez en arrière et vous franchissez la porte d'entrée à reculons, les mains crispées sur votre poitrine en feu. De la fumée jaillit de la boutique et il vous faut prendre la fuite avant que le Sage et son Voleur vous attrapent. Vous parvenez à rejoindre la grand-rue et vous vous fondez dans la foule. Rendez- vous au 7.",
    "choices": []
  },
  "81": {
    "id": "81",
    "text": "Une heure plus tard environ, les Kraans et leurs terribles cavaliers disparaissent en direction de l'ouest. Les réfugiés, tremblants de peur, sortent alors de la forêt, et vous entendez au même moment des chevaux au galop s'approcher de l'endroit où vous êtes. Ce sont des soldats de la cavalerie royale qui portent l'uniforme blanc des armées de Sa Majesté. Si vous souhaitez leur faire signe, rendez-vous au 183. Si vous préférez poursuivre votre chemin vers le sud en longeant la lisière de la forêt, rendez- vous au 200.",
    "choices": [
      {
  ...
  "83": {
    "id": "83",
    "text": "Vous avez couru pendant presque deux kilomètres lorsque trois soldats surgissent de sous un petit pont. Ils vous ordonnent de vous arrêter et de déposer à terre vos armes et tout votre équipement. Leurs uniformes sont tachés de sang et ils ont négligé de se raser. Leur chef porte une tunique de la garnison de Toran. Si vous décidez de leur obéir, rendez-vous au 205. Si vous préférez vous préparer à les combattre, rendez-vous au 180. Si vous souhaitez leur demander ce qu'ils veulent, rendez- vous au 232. Enfin, si vous maîtrisez la Discipline Kaï du Sixième Sens, rendez-vous au 45.",
    "choices": [
      {
  ...
  "84": {
    "id": "84",
    "text": "Au moment où vous sentez le vent de ses ailes sur votre dos, vous vous laissez tomber de votre cheval et vous roulez sur vous- même en terminant votre course dans la bouc d'un fossé, au bord de la route. Vous êtes indemne et vous vous relevez d'un bond pour courir vous mettre à l'abri des arbres ; mais il vous reste une trentaine de mètres à parcourir et le Kraan se prépare à fondre sur vous une nouvelle fois. Rendez-vous au 188.",
    "choices": [
      {
  ...
  "86": {
    "id": "86",
    "text": "Vous atteignez bientôt un nouveau croisement. Si vous voulez aller vers l'est, rendez-vous au 6. Si vous préférez prendre la direction du nord, rendez-vous au 35. Si vous estimez plus judicieux d'aller vers le sud, rendez-vous au 167. Si enfin vous décidez plutôt de tourner vers l'ouest, rendez-vous au 42.",
    "choices": [
      {
  ...
  "89": {
    "id": "89",
    "text": "Vous dévalez le flanc escarpé de la colline dans un nuage de poussière et de cailloux. Le Kraan continue de tournoyer au- dessus de votre tête comme pour guider les Gloks vers vous. Utilisez la Table de Hasard pour obtenir un chiffre : si vous tirez 0 ou 1, rendez-vous au 53. Entre 2 et 4, rendez-vous au 274. Entre 5 et 9, rendez-vous au 316.",
    "choices": [
      {
  ...
  "90": {
    "id": "90",
    "text": "La nuit tombe et vous vous retrouvez bientôt dans une obscurité totale. Il ne servirait à rien de poursuivre votre chemin, car vous vous perdriez à coup sûr. Vous attachez donc votre cheval à un arbre, vous vous étendez sur le sol en vous couvrant de votre cape et vous sombrez dans un sommeil agité. Rendez-vous au 18.",
    "choices": [
      {
  ...
  "94": {
    "id": "94",
    "text": "Voyant que vous avez tué son fils, le Sage fait volte-face et s'enfuit de la boutique par la porte de derrière. Vous trouvez 12 Pièces d'Or dans la bourse du Voleur et 4 autres dans une boîte en bois, rangée sous le comptoir. Vous examinez ensuite les potions et la baguette magique, et vous vous apercevez qu'il s'agit de simples imitations sans aucune valeur. Il n'y a rien dans la boutique qui mérite votre attention et vous quittez les lieux pour rejoindre la grand-rue. Rendez-vous au 7.",
    "choices": [
      {
  ...
  "95": {
    "id": "95",
    "text": "Vous arrivez bientôt sur un chemin forestier orienté nord-sud. Si vous souhaitez suivre ce chemin étroit en direction du nord, rendez-vous au 240. Si vous préférez aller au sud, rendez-vous au 5.",
    "choices": [
      {
  ...
  "100": {
    "id": "100",
    "text": "Le couloir glacial tourne brusquement vers l'est et vous apercevez au loin une lueur verdâtre qui diffuse une faible clarté. Vous constatez bientôt que le couloir aboutit à une grande pièce, et que l'étrange lumière provient d'une sorte de coupe, posée sur le haut dossier d'un trône de granité. Devant le trône, se trouve une statue sur son socle. Elle représente un serpent ailé dont le corps a la forme d'un S. Si vous souhaitez vous asseoir sur ce trône, rendez-vous au 161. Si vous préférez examiner la statue, rendez-vous au 133. Enfin, s'il vous semble plus judicieux de chercher une sortie qui vous permettrait de quitter cet endroit, rendez-vous au 257.",
    "choices": [
      {
  ...
  "103": {
    "id": "103",
    "text": "Le chemin, couvert de broussailles, bifurque bientôt et un autre sentier permet d'aller vers l'est. Si vous souhaitez emprunter ce nouveau chemin orienté à l'est, rendez-vous au 13. Si vous préférez poursuivre votre route en direction du nord-est, rendez- vous au 287.",
    "choices": [
      {
  ...
  "107": {
    "id": "107",
    "text": "Vous traversez la pièce en courant et vous vous servez de votre arme pour fracasser les crânes qui se brisent en mille morceaux. Chacun des crânes est rempli d'une gelée grise et bouillonnante qui se met à trembler et à changer de forme. A la surface luisante de cette étrange substance apparaissent bientôt des ailes de chauves-souris et des ventouses. Saisi d'horreur et de dégoût, vous vous précipitez alors vers le couloir et vous quittez les lieux au moment même où une lourde herse s'abat à l'entrée de la pièce dont elle interdit désormais l'accès. Rendez-vous au 23.",
    "choices": [
      {
  ...
  "116": {
    "id": "116",
    "text": "Des flèches noires s'abattent tout autour de vous lorsque vous vous hissez hors de l'eau boueuse. Vous vous précipitez vers les arbres pour vous mettre à couvert et attendre que les Gloks aient quitté la rive opposée. Vous reprenez ensuite votre chemin en direction de la capitale. Rendez-vous au 321.",
    "choices": [
      {
  ...
  "121": {
    "id": "121",
    "text": "Après quelques minutes de marche, vous apercevez la silhouette d'un homme vêtu de rouge qui se tient debout au milieu du chemin. Il vous tourne le dos, et un capuchon lui couvre la tête. Le corbeau noir que vous avez vu un peu plus tôt est perché sur son bras tendu. Si vous souhaitez appeler cet homme, rendez- vous au 342. Si vous préférez vous approcher de lui avec prudence, rendez-vous au 309. Enfin, si vous estimez plus judicieux de dégainer votre arme et de l'attaquer, rendez-vous au 283.",
    "choices": [
      {
  ...
  "123": {
    "id": "123",
    "text": "Lorsque la créature meurt, son corps se dissout en une espèce de liquide verdâtre et répugnant. Vous remarquez alors que les herbes et les plantes sur lesquelles se répand cette substance fumante se ratatinent et meurent aussitôt. Une Pierre Précieuse de bonne taille apparaît parmi les herbes, près du corps en décomposition. Plus loin sur le sentier, vous apercevez une meute de Gloks qui se précipitent vers vous. Si vous souhaitez ramasser la Pierre Précieuse, rendez-vous au 304. Si vous préférez partir à l'instant en prenant vos jambes à votre cou, rendez-vous au 2.",
    "choices": [
      {
  ...
  "126": {
    "id": "126",
    "text": "Vous chevauchez de plus en plus loin dans la forêt et, dans votre for intérieur, vous remerciez le Prince de vous avoir donné un si bon cheval, car bien que le sol soit entièrement recouvert d'un enchevêtrement de buissons et de racines, l'étalon blanc n'a jamais fait le moindre faux pas. Bientôt les Loups Maudits sont loin derrière vous et vous arrêtez votre cheval. La lumière commence à décliner, il fait presque nuit, à présent. Si vous souhaitez poursuivre votre chemin dans la même direction, rendez-vous au 46. Si vous préférez aller à gauche (dans une direction parallèle au chemin que vous avez laissé loin derrière), rendez-vous au 143.",
    "choices": [
      {
  ...
  "129": {
    "id": "129",
    "text": "Vous parvenez devant la porte principale de la ville et vous contemplez avec révérence les murs gigantesques qui se dressent devant vous. Hautes de soixante mètres, les murailles de Holmgard ont résisté tout à la fois au Temps et aux Maîtres des Ténèbres. L'officier et vous-même parcourez au pas de course le tunnel d'une centaine de mètres de long qui traverse le poste fortifié et vous arrivez enfin devant l'entrée de la grande Tour de Guet. Des civils et des soldats en grand nombre courent en tous sens, chacun s'activant à sa tâche. Si vous souhaitez continuer à suivre l'officier, rendez-vous au 3. Si vous pensez que vous arriverez plus vite à la citadelle qui abrite le Palais du Roi en vous débrouillant tout seul, rendez-vous au 144.",
    "choices": [
      {
  ...
  "133": {
    "id": "133",
    "text": "Quand vous vous approchez de la statue, celle-ci commence à se craqueler et, soudain, elle explose devant vous tandis qu'un véritable serpent ailé, débarrassé de son manteau de pierre vous attaque férocement. Il vous faut combattre la créature. SERPENT AILÉ HABILETÉ : 16 ENDURANCE : 18 Votre adversaire est insensible à la Discipline Kaï de la Puissance Psychique. Si vous êtes vainqueur, rendez-vous au 266.",
    "choices": [
      {
  ...
  "135": {
    "id": "135",
    "text": "Parvenu au bord de l'escarpement de la berge, vous jetez un coup d'œil en contrebas et vous apercevez un enchevêtrement de débris de bois portés là par le courant. Un gros tronc d'arbre, notamment, s'est échoué sur la rive, à côté d'un petit canoë. Si vous souhaitez utiliser le tronc d'arbre pour descendre le cours de la rivière, rendez-vous au 223. Si vous préférez vous servir du canoë, rendez-vous au 4.",
    "choices": [
      {
  ...
  "138": {
    "id": "138",
    "text": "Vous dégainez votre arme et vous vous portez à la rencontre de l'ennemi. Ce sont deux Gloks que vous devrez combattre à tour de rôle. HABILETÉ ENDURANCE Premier GLOK 13 10 Deuxième GLOK 12 10 Si vous êtes vainqueur, rendez-vous au 291.",
    "choices": [
      {
  ...
  "140": {
    "id": "140",
    "text": "Vous vous trouvez dans une clairière au centre de laquelle on a élevé une tour branlante à l'aide de troncs d'arbres grossièrement taillés. Au pied de la tour, trois sentiers partent dans différentes directions. Si vous souhaitez prendre le sentier qui mène au sud, rendez-vous au 14. Si vous préférez celui qui mène à l'est, rendez-vous au 252. Si le sentier orienté au sud-ouest vous paraît plus attrayant, rendez-vous au 215. Enfin, si l'envie vous prend plutôt de monter dans la tour, rendez-vous au 36.",
    "choices": [
      {
  ...
  "141": {
    "id": "141",
    "text": "Votre Sixième Sens vous avertit que quelques-unes des créatures qui ont attaqué le monastère sont restées dans les environs et inspectent les deux chemins, en quête d'éventuels survivants à massacrer. Vous pouvez cependant éviter ces deux sentiers en coupant par les sous-bois de la forêt. Si vous souhaitez aller vers le sud, rendez-vous au 56. Si vous préférez vous frayer un chemin dans le feuillage plus touffu qui s'étend au nord-est, rendez-vous au 333.",
    "choices": [
      {
  ...
  "151": {
    "id": "151",
    "text": "En vous concentrant sur le trou de la serrure, vous pourrez peut- être actionner le mécanisme interne et repousser le pêne par votre seule force mentale. Vous ferez ensuite léviter la broche pour la libérer de ses attaches. En opérant ainsi à distance, vous resterez hors d'atteinte des pièges éventuels qui pourraient se déclencher lors de l'ouverture de la serrure. Pour savoir si votre Maîtrise Psychique de la Matière se révélera efficace dans le cas présent, rendez-vous au 87.",
    "choices": [
      {
  ...
  "168": {
    "id": "168",
    "text": "Vous vous hissez au sommet de la luxueuse roulotte et vous vous installez au milieu des malles et des valises. La nuit bientôt tombera sur la grand-route. Un vent frais souffle de l'ouest, qui vous oblige à bien serrer votre cape autour de vous pour n'avoir pas trop froid. Au-dessous, à l'intérieur de la roulotte, vous entendez des gens parler et une délicieuse odeur de viande rôtie vous monte aux narines. Elle vient vous rappeler que vous avez très faim et qu'il vous faut prendre un Repas, sinon, vous perdrez 3 points d'ENDURANCE. La fatigue a tôt fait d'avoir raison de vous et vous finissez par sombrer dans un sommeil agité. Rendez-vous au 64.",
    "choices": [
      {
        "text": "Rendez-vous au 64.",
        "targetId": "64"
  ...
  "176": {
    "id": "176",
    "text": "Vous vous cachez derrière d'épais buissons en espérant que le Loup Maudit et son cavalier ne verront pas votre cheval blanc. Par chance, votre ruse réussit et les malfaisantes créatures passent devant vous sans vous remarquer, puis s'éloignent le long du sentier que vous venez de quitter. Si vous souhaitez attaquer les autres Loups Maudits et leurs cavaliers, rendez-vous au 253. Si vous préférez poursuivre votre chemin en vous enfonçant plus avant dans la forêt, rendez-vous au 126.",
    "choices": [
      {
  ...
  "178": {
    "id": "178",
    "text": "Votre Sixième Sens vous permet de reconnaître à distance les bottes et les guêtres d'un soldat de l'armée royale. Vous sentez également que cet homme est blessé et qu'il a besoin d'aide. Si vous souhaitez lui porter secours, rendez-vous au 88. Si vous préférez l'abandonner à son sort et poursuivre votre chemin, rendez-vous au 264.",
    "choices": [
      {
  ...
  "179": {
    "id": "179",
    "text": "Vous avez été repéré par les gardes qui vous mettent en joue avec leurs arbalètes. Si vous souhaitez lever les mains et avancer vers eux, rendez-vous au 318. Si vous préférez prendre vos jambes à votre cou pour vous cacher parmi les arbres, rendez-vous au 51.",
    "choices": [
      {
  ...
  "180": {
    "id": "180",
    "text": "Ils vous voient lever votre arme et vous attaquent aussitôt. Si vous souhaitez engager le combat, vous les affronterez à tour de rôle. HABILETÉ ENDURANCE CHEF DES SOLDATS 15 22 Premier SOLDAT 13 20 Deuxième SOLDAT 12 20 Si vous parvenez à les tuer tous les trois, rendez-vous au 62. Si vous souhaitez prendre la fuite, rendez-vous au 22.",
    "choices": [
      {
  ...
  "182": {
    "id": "182",
    "text": "Trois Gardes-Frontières de l'armée royale galopent le long de la rive, suivis de près par des Gloks chevauchant leurs terribles montures, des Loups Maudits. Votre science du Camouflage vous a cependant évité d'être vu et les Gloks diaboliques continuent leur poursuite sans même jeter un coup d'œil du côté de la rivière. Rendez-vous au 174.",
    "choices": [
      {
  ...
  "189": {
    "id": "189",
    "text": "Grâce à votre entraînement de Seigneur Kaï et à la promptitude de vos réflexes, vous avez échappé à ce marécage qui aurait pu se révéler tout aussi meurtrier qu'un Kraan ou un Drakkarim. Vous êtes contrarié d'avoir perdu du temps et vous vous hâtez de poursuivre votre chemin parmi les arbres, en direction du sud. Un peu plus loin devant vous, un large chemin mène également vers le sud. Rendez-vous au 118.",
    "choices": [
      {
        "text": "Rendez-vous au 118.",
        "targetId": "118"
  ...
  "191": {
    "id": "191",
    "text": "Le garde du corps dégaine un long cimeterre et s'apprête à vous attaquer. GARDE DU CORPS HABILETÉ : 11 ENDURANCE : 21 Si vous êtes vainqueur, rendez-vous au 24. Si vous souhaitez prendre la fuite au cours du combat, vous pourrez sauter de la roulotte en vous rendant au 234.",
    "choices": [
      {
  ...
  "195": {
    "id": "195",
    "text": "Vous essuyez votre arme qui ruisselle du sang de l'ours et vous remarquez l'entrée d'une grotte cachée derrière les rochers d'où a surgi la bête sauvage. Si vous souhaitez explorer cette grotte, rendez-vous au 59. Si vous préférez poursuivre votre chemin, rendez-vous au 106.",
    "choices": [
      {
  ...
  "199": {
    "id": "199",
    "text": "La plupart des placards et des tiroirs sont vides. Les habitants de cette maison ont presque tout emporté avec eux ; vous parvenez cependant à trouver dans la cave suffisamment de fruits pour vous faire un Repas. Notez-le sur votre Feuille d'Aventure. Rendez-vous ensuite au 81.",
    "choices": [
      {
  ...
  "202": {
    "id": "202",
    "text": "Vous galopez le long de la grand-route qui mène à la capitale lorsque votre cheval ralentit soudain l'allure, se met à boiter, puis s'arrête. Vous mettez pied à terre pour examiner sa jambe avant droite qu'il tient levée : il a perdu un fer et s'est blessé au sabot. En maudissant votre mauvaise fortune, vous l'abandonnez donc sur le bas-côté et vous poursuivez à pied votre chemin. Rendez- vous au 58.",
    "choices": []
  },
  "203": {
    "id": "203",
  ...
  "213": {
    "id": "213",
    "text": "Il y a bien deux heures à présent que vous vous frayez un chemin dans la forêt et votre crainte de vous être perdu semble bel et bien justifiée. Vous n'avez décelé aucune trace témoignant de la présence de l'ennemi dans cette partie de la forêt ; seul le cri d'un Kraan au lointain est venu parfois troubler la quiétude qui règne alentour. Cependant, en descendant le flanc rocheux d'une petite colline, vous remarquez soudain quelque chose d'insolite dans l'enchevêtrement des sous-bois qui s'étendent devant vous. Rendez-vous au 331.",
    "choices": [
      {
  ...
  "220": {
    "id": "220",
    "text": "Le Garde du Corps dégaine un long cimeterre et s'apprête à vous en enfoncer la lame dans la poitrine. GARDE DU CORPS HABILETÉ : 11 ENDURANCE : 20 Si vous êtes vainqueur, rendez-vous au 24. Si vous souhaitez prendre la fuite au cours du combat, vous pouvez sauter de la roulotte en vous rendant au 234.",
    "choices": [
      {
  ...
  "222": {
    "id": "222",
    "text": "Vous arrivez bientôt sur un chemin forestier qui bifurque à cet endroit. Si vous souhaitez prendre le sentier orienté au sud, rendez-vous au 140. Si vous préférez emprunter la branche est, rendez-vous au 252. Enfin, si vous maîtrisez la Discipline Kaï du Sens de l'Orientation, rendez-vous au 67.",
    "choices": [
      {
  ...
  "223": {
    "id": "223",
    "text": "Après bien des efforts, vous parvenez à dégager le tronc de tous les débris qui l'entourent. Vous attachez ensuite toutes vos affaires en un paquet bien serré que vous coincez dans un creux du tronc d'arbre, puis vous vous y installez vous-même à califourchon. Le courant bientôt vous emporte et vous dérivez lentement au fil de l'eau. Une vingtaine de minutes plus tard, vous entendez des chevaux galoper au loin, sur la rive gauche. Si vous souhaitez vous cacher derrière le tronc, rendez-vous au 75. Si vous préférez signaler votre présence aux cavaliers qui s'approchent, rendez-vous au 175,",
    "choices": [
      {
  ...
  "224": {
    "id": "224",
    "text": "Vous avez parcouru plusieurs kilomètres à cheval sans trouver trace de réfugiés ou d'ennemis. Vous vous dirigez alors vers un chemin qui s'élève un peu plus loin à flanc de colline. Sur cette hauteur, vous devriez apercevoir la capitale. En arrivant là-haut, vous contemplez en effet un spectacle qui vous remplit d'espoir, mais qui vous fait frémir également : vous n'êtes décidément pas au bout de vos peines... Rendez-vous au 153.",
    "choices": [
      {
  ...
  "225": {
    "id": "225",
    "text": "Ce langage est celui des Kakarmis, une race d'animaux forestiers, doués d'intelligence, qui habitent les forêts du Sommerlund. Vous n'avez rien à redouter de ces créatures timides et paisibles et votre Sens de la Communication Animale vous permet de leur parler dans leur étrange dialecte. Que désirez-vous leur dire ? « N'ayez pas peur, je viens en ami » ? Rendez-vous dans ce cas au 187. « Je suis un Seigneur Kaï, je ne vous veux aucun mal, je souhaite simplement parler avec vous » ? Rendez-vous alors au 39.",
    "choices": [
      {
  ...
  "226": {
    "id": "226",
    "text": "Tout d'abord, la descente vous paraît facile mais, bientôt, votre vue se brouille et vous sentez vos jambes faiblir. Les Dents de Sommeil commencent à produire leur effet et, soudain, vous trébuchez et vous perdez connaissance en tombant tête la première. Utilisez la Table de Hasard pour obtenir un chiffre. Si vous tirez un chiffre entre 0 et 4, rendez-vous au 277. Entre 5 et 9, rendez-vous au 338.",
    "choices": [
      {
  ...
  "227": {
    "id": "227",
    "text": "Vous avez maintenant de la vase jusqu'à la ceinture, l'air est lourd et de petits insectes vous piquent le visage et vous bouchent le nez. Puis soudain, quelque chose s'enroule autour de vos jambes. C'est une Vipère des Marais qu'il vous faut combattre. VIPÈRE DES MARAIS HABILETÉ: 16 ENDURANCE: 6 Si vous perdez des points d'ENDURANCE au cours du combat, rendez-vous au 271. Si vous parvenez à tuer la Vipère sans perdre aucun point d'ENDURANCE, rendez-vous au 348.",
    "choices": [
      {
  ...
  "228": {
    "id": "228",
    "text": "Le sentier continue vers l'est puis disparaît bientôt sous d'épaisses broussailles. Si vous souhaitez poursuivre vers l'est en vous frayant un chemin à coups de hache, rendez-vous au 140. Si vous préférez aller vers le sud, là où les sous-bois sont moins touffus et vous enfoncer plus avant dans la forêt, rendez-vous au 215.",
    "choices": [
      {
  ...
  "232": {
    "id": "232",
    "text": "Leur chef, à l'allure patibulaire, s'approche de vous et vous déclare ceci : « Ce que nous voulons ? C'est très simple, cher monsieur : votre bourse ou votre vie ! » Si vous souhaitez les combattre, rendez-vous au 180. Si vous préférez tenter de vous enfuir, rendez-vous au 22.",
    "choices": [
      {
  ...
  "233": {
    "id": "233",
    "text": "Il vous faut presque une heure pour rattraper le cheval et parvenir à le calmer. Vous vous êtes éloigné de la cabane en direction du nord mais vous êtes sûr de pouvoir retrouver votre chemin. Vous montez sur le dos du cheval et vous retournez jusqu'à la cabane, puis vous poursuivez votre route en direction du sud. Rendez-vous au 206.",
    "choices": [
      {
  ...
  "245": {
    "id": "245",
    "text": "Des flèches viennent frapper la surface de la rivière sans vous faire le moindre mal : vous nagez sous l'eau, en effet, et il est impossible de vous atteindre. Vous touchez bientôt la rive opposée et vous vous hissez sur la terre ferme avant de courir vous mettre à l'abri dans la forêt. Vous êtes maintenant hors d'atteinte des Gloks qui enfourchent à nouveau leurs Loups Maudits et reprennent leur poursuite. Rendez-vous au 190.",
    "choices": [
      {
        "text": "Rendez-vous au 190.",
        "targetId": "190"
  ...
  "247": {
    "id": "247",
    "text": "Le marchand a l'air furieux. Il appelle son garde du corps et il vous faut prendre une décision rapide. Si vous souhaitez lui offrir quelque chose de plus grande valeur, parmi les objets que contient votre Sac à Dos, rendez-vous au 159. Si vous préférez combattre le garde du corps, rendez-vous au 220.",
    "choices": [
      {
  ...
  "248": {
    "id": "248",
    "text": "Vous parvenez au pied de la colline et vous vous hâtez de courir dans la forêt. Quelques minutes plus tard, vous découvrez un ancien sentier forestier qui forme ici une courbe à angle droit. Si vous souhaitez suivre ce sentier en direction du nord, rendez- vous au 44. Si vous préférez le suivre en direction de l'est, rendez-vous au 300.",
    "choices": [
      {
  ...
  "253": {
    "id": "253",
    "text": "Les Loups Maudits sont bientôt sur vous et il vous faut les combattre un par un. HABILETÉ ENDURANCE Premier LOUP MAUDIT 13 24 Deuxième LOUP MAUDIT 14 23 Troisième LOUP MAUDIT 14 22 Quatrième LOUP MAUDIT 15 21 Si vous parvenez à les tuer tous, rendez-vous au 278.",
    "choices": [
      {
  ...
  "257": {
    "id": "257",
    "text": "Vous trouvez une grande porte de pierre aménagée dans le mur est, mais il semble tout à fait impossible de l'ouvrir. Si vous voulez examiner la statue, rendez-vous au 133. Si vous préférez vous asseoir sur le trône, rendez-vous au 161.",
    "choices": [
      {
  ...
  "262": {
    "id": "262",
    "text": "Le marchand prend votre or et claque des doigts. Son garde du corps vous attaque aussitôt. Si vous souhaitez le combattre, rendez-vous au 191. Si vous préférez éviter l'affrontement, vous pouvez sauter en marche de la roulotte en vous rendant au 234.",
    "choices": [
      {
        "text": "Si vous souhaitez le combattre, rendez-vous au 191.",
        "targetId": "191"
  ...
  "267": {
    "id": "267",
    "text": "En vous couvrant le nez d'un pan de votre cape, vous vous approchez avec précaution du Kraan mort. L'odeur infecte qui se dégage de son sang noir vous retourne l'estomac, mais vous êtes décidé malgré tout à examiner son cadavre. Vous remarquez alors un sac attaché au corps du monstre par une sangle. A l'intérieur du sac, vous trouvez un Message écrit sur une peau d'animal. Tout au fond du sac, il y a également un Poignard. Vous pouvez conserver ce Message et ce Poignard si vous le désirez. Vous abandonnez ensuite le cadavre du monstre et vous poursuivez votre chemin en direction de l'est. Rendez-vous au 125.",
    "choices": [
      {
  ...
  "270": {
    "id": "270",
    "text": "Vous entendez les hurlements furieux de l'ennemi qui vous parviennent de l'autre côté du lac. Il vous faut partir au plus vite avant que d'autres Kraans apparaissent. Vous remontez donc sur votre cheval et vous poursuivez votre chemin en vous enfonçant plus avant dans la forêt. Rendez-vous au 21.",
    "choices": [
      {
  ...
  "277": {
    "id": "277",
    "text": "Lorsque vous reprenez conscience, vous êtes étendu au pied d'une pente raide, parmi les hautes herbes. Vous n'apercevez ni votre Arme ni votre Sac à Dos, et votre tête vous fait atrocement souffrir. Vous êtes incapable de dire combien de temps vous êtes resté sans connaissance, mais il est clair qu'il vous faut repartir sans plus attendre. Vous vous relevez donc aussitôt et vous retrouvez votre Sac à Dos intact. Votre Arme, en revanche, est brisée et ne peut plus vous être d'aucune utilité. Rayez-la de votre Feuille d'Aventure (si vous possédez plus d'une arme, seule l'une d'elles est cassée et vous pouvez choisir laquelle). Une fois votre Feuille d'Aventure modifiée, vous ramassez votre Sac à Dos ainsi que l'Arme qui vous reste éventuellement et vous poursuivez votre chemin dans la forêt qui s'étend devant vous. Rendez-vous au 113.",
    "choices": [
      {
  ...
  "292": {
    "id": "292",
    "text": "La dernière sensation que vous emporterez de ce monde n'a rien de réjouissant : vous êtes, en effet, littéralement englouti dans d'épaisses ténèbres où vous mènerez désormais une existence d'esclave dans un univers hors du temps et de l'espace. Votre maître pour l'éternité est une entité maléfique dont l'origine se perd dans la nuit des temps. Votre aventure vient de prendre fin.",
    "choices": []
  },
  "293": {
    "id": "293",
    "text": "Banedon quitte les ruines du temple en vous adressant un signe de la main, et vous poursuivez vous-même votre route en vous enfonçant dans la forêt touffue qui s'étend devant vous. Quelques centaines de mètres plus loin, vous sentez des regards se poser sur vous. Des yeux jaunes brillent dans les sous-bois et, soudain, une flèche noire vous frôle la tête. Ce sont des Gloks qui vous ont tendu une embuscade, et il vous faut prendre la fuite aussi vite que possible. Rendez-vous au 281.",
    "choices": [
      {
  ...
  "306": {
    "id": "306",
    "text": "Les échos de la bataille s'évanouissent peu à peu derrière vous. Et soudain, vous vous retrouvez plaqué au sol : trois Drakkarims, cachés dans le feuillage d'un arbre, juste au-dessus de votre tête, vous ont sauté dessus. Il est inutile d'essayer de lutter : ils sont trop nombreux et trop robustes pour espérer pouvoir leur échapper. Vous les entendez alors grogner de plaisir tandis qu'ils lèvent leurs lances pour vous achever : c'est la dernière vision que vous emporterez de ce monde. Votre mission s'achève ici, en même temps que votre vie.",
    "choices": []
  },
  "307": {
    "id": "307",
  ...
  "337": {
    "id": "337",
    "text": "Au moment où vous ôtez la broche, un craquement assourdissant retentit. Utilisez la Table de Hasard pour obtenir un chiffre. Si vous tirez un chiffre entre 0 et 4, rendez-vous au 219. Entre 5 et 9, rendez-vous au 317.",
    "choices": [
      {
  ...
  "338": {
    "id": "338",
    "text": "Lorsque vous reprenez conscience, vous êtes étendu au pied d'une pente escarpée, sur un tapis de hautes herbes. Vous ne voyez plus ni votre Sac à Dos ni votre Arme, et votre tête vous fait très mal. Vous ne sauriez dire combien de temps vous êtes resté sans connaissance, mais quoi qu'il en soit, le temps presse, et il vous faut au plus vite poursuivre votre route. Vous vous relevez donc aussitôt et vous apercevez votre Sac à Dos et votre Arme un peu plus haut sur la pente. Ils ont dû se détacher au cours de votre chute. Vous vous hâtez de les récupérer et vous repartez dans la forêt. Rendez-vous au 113.",
    "choices": [
      {
        "text": "Rendez-vous au 113.",
        "targetId": "113"
