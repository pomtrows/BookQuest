...
epub_path = r"C:\PROJET\Target\Epub\LDVELH - Loup Solitaire 02 - La - LDVELH LS02 - Dever,Joe (1).epub"
out_path = r"C:\PROJET\Book Quest\src\data\book2.ts"
...
if len(story_data) > 0:
    ts_content = "import type { Section } from '../types/game';\n\nexport const storyDataBook2: Record<string, Section> = " + json.dumps(story_data, ensure_ascii=False, indent=2) + ";\n"
